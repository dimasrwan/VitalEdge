...
class HealthController extends Controller
{
    ...
    // Hitung BMI berdasarkan log terbaru dan tinggi badan user
    ...
    return view(auth()->check() ? 'dashboard' : 'welcome', 
        compact('logs', 'chartData', 'bmi', 'bmiLabel'));
}
    ...
    // Ini memastikan BMI selalu terhitung dengan tinggi badan terbaru
    $user->update([
    ...
    public function destroy($id) {
        // Pastikan hanya pemilik data yang bisa menghapus (Keamanan Tambahan)
